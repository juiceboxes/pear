...
class Pie extends Component {
    ...
    updateLabels(pie) {
        if (this.props.withLegend) {
            select(this.legend)
            .selectAll('div.pear-l-pie__legend--item')
            .each(function() {
                select(this)
    ...
    render () {
        ...
        if (this.props.withLegend) {
            pieLegend =
            <div className='pear-l-pie__legend' ref={ ref => {this.legend = ref;} }>
                { this.props.values && this.props.values.map(oneItem => (
                    <div key={ oneItem }  data-id={ oneItem[0] } className="pie pear-l-pie__legend--item">
        ...
        return (
            <div className={ wrapperClasses } widget-type='PearPie' widget-id={ this.props.identifier } >
                <div className='pear-l-pie'>
